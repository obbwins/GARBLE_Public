...
class CustomTextGenerationPipeline:
    ...
    def __call__(self, prompt, **kwargs):
        ...
        print("Input IDs:\n", inputs['input_ids'])
        # Generate output
        outputs = REMOVED_SECRET(**inputs, streamer=self.streamer, output_hidden_states=True, return_dict_in_generate=True, **kwargs)
...
def answer_with_rag(
    ...
    generated_sequence, logits = READER_LLM(final_prompt, max_new_tokens=500, do_sample=True, temperature=0.2)
    print("Generated Sequence (Token IDs):\n", generated_sequence)
    answer = REMOVED_SECRET(generated_sequence[0], skip_special_tokens=True, clean_up_tokenization_spaces=True)  
...
if __name__ == "__main__":
    ...
    Always respond directly from the documents provided.
